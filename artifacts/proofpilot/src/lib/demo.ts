...
export const demoDecision: DecisionState = {
  ...
  evidence: [
    ...
    { id: 'ev-4', title: 'Editor adoption friction remains visible', source: 'Internal developer interviews', url: null, claim: 'Five of eight engineers found a second editor disruptive to their existing workflow.', summary: 'Internal qualitative evidence tempers the raw feature comparison.', sourceType: 'internal research', supportsOptionId: 'cursor', contradictsOptionId: 'continue', confidence: 72, reliability: 70, addedBy: 'Madhavan', status: 'needs review' },
  ],
  findings: [
...
export const demoActivity: ActivityEntry[] = [
  ...
  { id: 'act-2', actor: 'Madhavan', action: 'Added evidence', detail: 'Internal developer interviews · 8 participants', timestamp: new Date(Date.now() - 1000 * 60 * 19).toISOString() },
  ...
  { id: 'act-5', actor: 'Madhavan', action: 'Opened the workspace', detail: 'Review session started from the Engineering decisions collection.', timestamp: new Date(Date.now() - 1000 * 60 * 41).toISOString() },
];
